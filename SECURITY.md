...
For `fedora-debugg`, security-sensitive reports should be handled privately by the repository owner.
...
- Do not commit crash bundles, journal exports, or other host-specific artifacts from `artifacts/`.
